...
public final class MontgomeryIntegerPolynomialP256 extends IntegerPolynomial implements IntegerMontgomeryFieldModuloP, IntegerResidueMontgomeryFieldModuloP { 
    ...
    public ImmutableIntegerModuloP toMontgomery(ImmutableIntegerModuloP n) {
        ...
        // if (n.getField() != IntegerPolynomialP256.ONE) {
        //     throw new RuntimeException("VP was here" + n.getField().getClass().getName());
        // }
    ...
    // @Override
    protected void reduceBad(long[] a) {
        long aa0 = a[0];
        long aa1 = a[1];
        long aa2 = a[2];
        long aa3 = a[3];
        long aa4 = a[4];
        long n = aa0 & LIMB_MASK;
        long n0, n1, n2, n3, n4, nn0, nn1, nn2, nn3, nn4;
        ...
        c4 = n0 + aa0;
        c5 = n1 + aa1 + nn0 + (c4 >>> BITS_PER_LIMB);
        c6 = n2 + aa2 + nn1 + (c5 >>> BITS_PER_LIMB);
        c7 = n3 + aa3 + nn2 + (c6 >>> BITS_PER_LIMB);
        c8 = n4 + aa4 + nn3 + (c7 >>> BITS_PER_LIMB);
        c9 =            nn4 + (c7 >>> BITS_PER_LIMB);
        ...
        a[0] =  ((c5 & mask) | (c0 & ~mask)) & LIMB_MASK;
        a[1] =  ((c6 & mask) | (c1 & ~mask)) & LIMB_MASK;
        a[2] =  ((c7 & mask) | (c2 & ~mask)) & LIMB_MASK;
        a[3] =  ((c8 & mask) | (c3 & ~mask)) & LIMB_MASK;
        a[4] =  ((c9 & mask) | (c4 & ~mask)) & LIMB_MASK;
    }

    @Override
    protected void multByInt(long[] a, long b) {
        // if (a[0]==0) {
            // debugRow("small< "+b, a, 0, NUM_LIMBS);
