...
#define __ masm->
  ...
  void generate_all() {
    ...
    if (UsePolyIntrinsics) {
      StubRoutines::x86::_poly1305_mask44 =   generate_vector_mask("poly1305_mask44",   0x00000fffffffffff);
      StubRoutines::x86::_poly1305_mask42 =   generate_vector_mask("poly1305_mask42",   0x000003ffffffffff);
      StubRoutines::x86::_poly1305_mask_pad = generate_vector_mask("poly1305_mask_pad", 0x0000010000000000);
