...
#include CPU_HEADER(stubRoutines)
  ...
  static address _intpoly_montgomeryReduce_P256;
  static address _intpoly_montgomeryAssign_P256;
 ...
 public:
  ...
  static address intpoly_montgomeryReduce_P256()        { return _intpoly_montgomeryReduce_P256; }
  static address intpoly_montgomeryAssign_P256()        { return _intpoly_montgomeryAssign_P256; }
