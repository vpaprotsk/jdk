 ...
 * @run main/othervm -XX:+UnlockDiagnosticVMOptions  -XX:-UseIntPolyIntrinsics MontgomeryPolynomialTest
 * @summary Unit test MontgomeryIntegerPolynomialTest.
 */
...
public class MontgomeryPolynomialTest {
        ...
        private static void check(BigInteger reference, ImmutableIntegerModuloP testValue) {
        ...
        public static void run() throws Exception {
                ...
                BigInteger MODULUS = MontgomeryIntegerPolynomialP256.ONE.MODULUS;
                BigInteger reference = (new BigInteger(MODULUS.bitLength(), rnd)).mod(MODULUS);
                ImmutableIntegerModuloP testValue = montField.getElement(reference);

                check(reference, testValue);
        }
}

//make test TEST="test/jdk/com/sun/security/util/math/intpoly/MontgomeryPolynomialTest.java"